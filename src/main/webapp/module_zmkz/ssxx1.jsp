...
<body>
    <div style="position:absolute;width:1692px;height:815px;background:url(../images/zmjk.jpg);overflow:auto;">
        <div style="position:absolute;width:99%;height:25px;text-align:center;padding: 5px">
            <span style="font:normal 25px '宋体'; color:#ff0000;line-height:25px;text-align:center; ">1#闸门</span>
        </div>
        
        <div style="position:absolute;left:260px;top:80px;">
            <span style="font:normal 25px '宋体'; color:#ffff00;">1#工作闸门</span><br>
        ...
        <div style="position:absolute;left:1350px;top:80px;">
            <span style="font:normal 25px '宋体'; color:#ffff00;">1#检修闸门</span><br>
        ...
        <div style="position:absolute;left:700px;top:120px;">
            <span style="font:normal 25px '宋体'; color:#ffff00;">1#工作闸门</span>
        </div>
        
        <div style="position:absolute;left:865px;top:120px;">
            <span style="font:normal 25px '宋体'; color:#ffff00;">1#检修闸门</span>
        </div>
