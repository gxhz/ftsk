...
<script language="javascript">
    ...
    function doSearch(){
        ...
        $('#myspan').html(year+'年'+month+'月 那板水库渗流月报表统计');
    }
    ...
    function exportExcel(){
		...
		window.location.href="ExportSDBBTJToExcel.action?CGQType=2&Flag=3&names="+syjname+"&SDate="+sdate+"&EDate="+edate+"&dtype="+dtype;
    }
        ...
        <div class="easyui-layout" data-options="fit:true">
            ...
            <div data-options="region:'center',border:false">
                <table id="tt" class="easyui-datagrid" pagination="false" 
                     url="GetSDBBTJData?CGQType=2&Flag=3" rownumbers="false" singleSelect="true" pageSize="200" fit="true">
                    <thead>
                        <tr>
