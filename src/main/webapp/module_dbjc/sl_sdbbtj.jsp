...
<script language="javascript">
    ...
    function doSearch(){
        ...
        for(var i=0;i<namearray.length;i++) {
        	array.push({field:'sysw'+(i*2+1),title:namearray[i]+'渗流量',width:'120'});
        	//array.push({field:'sysw'+(i*2+2),title:namearray[i]+'水温',width:'120'});
        }
        columns.push(array);
        ...
        $('#myspan').html(sdate+'至'+edate+' 那板水库渗流时段报表统计');
    }
    ...
    function exportExcel(){
		...
		window.location.href="ExportSDBBTJToExcel.action?CGQType=2&Flag=1&names="+syjname+"&SDate="+sdate+"&EDate="+edate+"&dtype="+dtype;
    }
    ...
    <div data-options="region:'center'" style="padding:5px;">
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'north',border:false" style="padding:6px;height:50px;text-align:center;background:#fffff">
                <span id="myspan" style="font:normal 25px '微软雅黑'; ">那板水库渗流时段报表统计</span>
            </div>
        
            <div data-options="region:'center',border:false">
                <table id="tt" class="easyui-datagrid" pagination="false" 
                     url="GetSDBBTJData?CGQType=2&Flag=1" rownumbers="false" singleSelect="true" pageSize="200" fit="true">
                    <thead>
                        <tr>
                          <th field="time" width="120">时间</th>
                          <th field="a" width="120">上游水位</th>
                          <th field="b" width="120">下游水位</th>
                          <th field="c" width="120">渗流量</th>
                        </tr>
                    </thead>
                </table>
            </div>
