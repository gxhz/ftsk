		...
		var yYHD = [466, 554, 678, 804, 928];
		 $.ajax({
			 ...
			 success:function(data){
				...
				{
					//画拆线
					drawDSX(canvas, pa1, xValues1, heightData1, 1, "#EA0000");
					drawDSX(canvas, pa2, xValues2, heightData2, 2, "#0000C6");
					drawDSX(canvas, pa3, xValues3, heightData2, 3, "#D26900");
					drawDSX(canvas, pa4, xValues4, heightData2, 4, "#AE57A4");
					//画溢洪道的名称和水位
