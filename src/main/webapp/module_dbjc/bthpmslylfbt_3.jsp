...
<script>
	...
	var xValues = [801, 981, 1113, 1261]; 
	var yTop =  156.44; //232.56f的位置
	var yTop2 =  202.7; //222.3的位置
	...
	var gkgc = [196.5, 177.8, 173, 171.2];	//管口高程
	var msgc1 = [195.53, 185, 178, 175.6];	//埋设高程
	var msgc2 = [198.86, 187, 180, 177.6];	//埋设高程
	
	function getData() {
		var sdate,dtype;
		var sname='PD1-1,PD2-1,PD3-1,PD4-1,PD1-2,PD2-2,PD3-2,PD4-2';
		var ksw=0.0;
		...
		ctx.fillText("0+200横剖面图", canvas.width / 2, 600);
		ctx.textAlign = "left";
