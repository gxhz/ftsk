...
<script language="javascript">
    ...
    function exportExcel(){
		...
		window.location.href="ExportSDBBTJToExcel.action?CGQType=2&Flag=2&names="+syjname+"&SDate="+sdate+"&EDate="+edate+"&dtype="+dtype;
    }
    ...
    <div data-options="region:'center'" style="padding:5px;">
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'north',border:false" style="padding:6px;height:50px;text-align:center;background:#fffff">
                <span id="myspan" style="font:normal 25px '微软雅黑'; ">那板水库渗流日报表统计</span>
            </div>
        
            <div data-options="region:'center',border:false">
                <table id="tt" class="easyui-datagrid" url="GetSDBBTJData?CGQType=2&Flag=2" 
