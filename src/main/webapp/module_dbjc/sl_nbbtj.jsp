...
<script language="javascript">
	...
	function doSearch(){
		...
		$('#myspan').html($('#year').combobox('getText')+' 那板水库 '+$('#dev').combobox('getText')+' 渗流年报表统计');
	}
    ...
    function exportExcel() {
    	...
    	window.location.href="ExportNBBTJToExcel.action?CGQType=2&Flag=4&names="+name+"&SDate="+sdate+"&EDate="+edate+"&dtype="+dtype;
    }  
        ...
        <div class="easyui-layout" data-options="fit:true">
            ...
            <div data-options="region:'center',border:false">
                <table id="tt" class="easyui-datagrid" pagination="false" toolbar="#tb" fitColumns="true"
                     url="GetNBBTJData?CGQType=2&Flag=4" rownumbers="false" singleSelect="true" pageSize="200" fit="true"
                     data-options="
