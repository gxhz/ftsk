...
<script>
	...
	var xValues = [841, 999, 1115, 1243]; 
	
	var yTop =  145.44; //232.56f的位置
	var yTop2 =  183.7; //222.3的位置
	var yUnit = (yTop2 - yTop)/(232.56-222.30); //以232.56为参照，找222.3f或其它任意一点算出来的单位高度
	
	//var yTop1 = 183.7; //222.3f的位置, 主要是用来算单位高度
	...
	var gkgc = [189.3, 174.8, 178, 165.2];	//管口高程
	var msgc1 = [189.3, 178.8, 178.2, 165.4];	//埋设高程
	var msgc2 = [191.1, 180.8, 180, 167.2];	//埋设高程
	
	function getData() {
		var sdate,dtype;
		var sname='PC1-1,PC2-1,PC3-1,PC4-1,PC1-2,PC2-2,PC3-2,PC4-2';
		var ksw=0.0;
		...
		ctx.drawImage(bgImg, 0, 0);
		 $.ajax({
            ...
            success:function(data) { 
				...
				ctx.fillText("库水位:"+ksw+" m", 720, 150);
             }
         }); 

		drawRule(canvas, yRules, 700, yTop, yUnit, 232.56);
		drawRule(canvas, yRules, canvas.offsetWidth -150, yTop, yUnit, 232.56);
		
		ctx.fillStyle = "#000000";
		ctx.font="20px Verdana";
		ctx.textAlign = "center";
		ctx.fillText("0+140横剖面图", canvas.width / 2, 600);
		ctx.textAlign = "left";
