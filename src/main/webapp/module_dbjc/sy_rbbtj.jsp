...
<script language="javascript">
    ...
    function doSearch(){
        ...
        $('#tt').datagrid({
            columns:columns,
            queryParams:{names: syjname,SDate: sdate,EDate: edate}
        });

      	$('#myspan').html(sdate+' 那板水库渗压日报表统计');
    }
    ...
    function exportExcel(){
		...
		window.location.href="ExportSDBBTJToExcel.action?CGQType=1&Flag=2&names="+syjname+"&SDate="+sdate+"&EDate="+edate;
    }
    ...
    <div data-options="region:'center'" style="padding:5px;">
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'north',border:false" style="padding:6px;height:50px;text-align:center;background:#fffff">
                <span id="myspan" style="font:normal 25px '微软雅黑'; ">那板水库渗压日报表统计</span>
            </div>
        
            <div data-options="region:'center',border:false">
                <table id="tt" class="easyui-datagrid" url="GetSDBBTJData?CGQType=1&Flag=2" 
                    pagination="false" rownumbers="false" singleSelect="true" pageSize="200" fit="true">
                    <thead>
                        <tr>
                          <th field="a" width="120">时间</th>
                          <th field="b" width="120">上游水位</th>
                          <th field="c" width="120">下游水位</th>
                          <th field="d" width="120">渗压水位</th>
                        </tr>
                    </thead>
                </table>
            </div>
