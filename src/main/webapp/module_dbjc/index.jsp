...
<body class="easyui-layout" >
    ...
    <div data-options="region:'west'" style="width:207px;padding:5px;background:#2D6AC7;">
        ...
        <div class="easyui-panel" title="数据整编" collapsible="true" collapsed="false" style="width:195px;height:auto;padding:10px;">
            ...
            <a href="#" onclick="openTab('262','syswysxyswgxt.jsp')">渗压水位与上下游水位差关系图</a><br>
            ...
            <a href="#" onclick="openTab('265','sllysxyswgxt.jsp')">渗流量与上下游水位差关系图</a><br>
            <a href="#" onclick="openTab('266','slylpmdsxfbt.jsp')">渗流压力平面等势线分布图</a>
        </div>
        <!-- 
        <div style="padding:3px;"></div>
