...
<script language="javascript">
    ...
    function doSearch(){
		...
		$.ajax({
            type:'post',
            dataType:'json',
            data:{CGQType:1,Flag:3,names:syjname,SDate:sdate,EDate:edate,dtype:dtype},
            	...
            	var strtime=[];
      			...
      			for(var i=0; i<selrows.length; i++){
          			...
          			for(var j=0;j<data.length-5;j++) {
          				sy[j] = Number(data[j]['sysw'+(i+1)]);  //渗压水位
                  	}
        ...
        $('#myspan').html(year+'年'+month+'月 那板水库渗压月过程线');
    }
    ...
    <div data-options="region:'center'" style="padding:5px;">
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'north',border:false" style="padding:6px;height:50px;text-align:center;background:#fffff">
                <span id="myspan" style="font:normal 25px '微软雅黑'; ">那板水库渗压月过程线</span>
            </div>
