...
<script language="javascript">
    ...
    function exportExcel() {
    	...
    	window.location.href="ExportJYLNBBTJToExcel.action?Flag=4&code="+code+"&name="+encodeURIComponent(name, "UTF-8")+"&sdate="+sdate+"&edate="+edate;
    }  
        ...
        <div class="easyui-layout" data-options="fit:true">
            ...
            <div data-options="region:'center',border:false">
                <table id="tt" class="easyui-datagrid" pagination="false" toolbar="#tb" fitColumns="true"
                     url="GetJYLNBBTJData?Flag=4" rownumbers="false" singleSelect="true" pageSize="200" fit="true"
                     data-options="
