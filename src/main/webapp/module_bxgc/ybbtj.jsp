...
<script language="javascript">
    ...
    function doSearch(){
        ...
        $('#myspan').html(year+'年'+month+'月 那板水库 '+strname+' 月报表统计');
    }
    ...
    function exportExcel(){
		...
		window.location.href="ExportBXSDBBTJToExcel.action?flag=3&names="+syjname+"&sdate="+sdate+"&edate="+edate+"&bname="+bname+"&dtype="+dtype;
    }
    ...
    <div data-options="region:'center'" style="padding:5px;">
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'north',border:false" style="padding:6px;height:50px;text-align:center;background:#fffff">
                <span id="myspan" style="font:normal 25px '微软雅黑'; ">那板水库水平位移月报表统计</span>
            </div>
        
            <div data-options="region:'center',border:false">
                <table id="tt" class="easyui-datagrid" pagination="false" 
                     url="GetBXSDBBTJData?flag=3" rownumbers="false" singleSelect="true" pageSize="200" fit="true">
                    <thead>
                        <tr>
