...
<script language="javascript">
    ...
    function doSearch(){
		...
		$.ajax({
            type:'post',
            dataType:'json',
            data:{flag:4,names:syjname,sdate:sdate,edate:edate,bname:bname,dtype:dtype},
        ...
        $('#myspan').html(year+'年 那板水库 '+strname+' 年过程线');
    }
    ...
    <div data-options="region:'center'" style="padding:5px;">
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'north',border:false" style="padding:6px;height:50px;text-align:center;background:#fffff">
                <span id="myspan" style="font:normal 25px '微软雅黑'; ">那板水库水平位移年过程线</span>
            </div>
