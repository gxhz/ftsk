...
<script language="javascript">
    ...
    function exportExcel() {
    	...
    	window.location.href="ExportAlarmToExcel.action?bjlb=1&sdate="+sdate+"&edate="+edate;
    }
...
<body class="easyui-layout">
    ...
    <div data-options="region:'north',border:false" style="padding:3px;height:40px;text-align:center;background:#fffff">
        <span id="myspan" style="font:normal 25px '微软雅黑'; ">变形观测报警查询</span>
    </div>

    <div data-options="region:'center',border:false" style="padding:5px;">
        <table id="tt" class="easyui-datagrid" pagination="true" toolbar="#tb"
             url='GetAlarmMsg?bjlb=1' rownumbers="true" singleSelect="true" pageSize="20" fitColumns="true" fit="true">
            <thead>
                <tr>
