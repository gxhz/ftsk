	...
	function doSearch(){
		...
		$.ajax({
            ...
            success:function(data) {
            	...
            	if(data.length > 0) $('#myspan').html(sdate+'至'+edate+' 那板水库 纵断面竖向位移分布图');
    	        ...
    	        myChart.setOption({
	               ...
	               tooltip: {
    	            ...
    	            yAxis: [
                        ...
                        {gridIndex: 3,name: '竖向位移量（mm）'},
                        {gridIndex: 4,name: '竖向位移量（mm）'},
                        {gridIndex: 5,name: '竖向位移量（mm）'}
    	            ],
    	            series: seriesStr
    	        }, true);
